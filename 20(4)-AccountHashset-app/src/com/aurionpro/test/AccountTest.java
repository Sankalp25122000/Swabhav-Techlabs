...
public class AccountTest {
	...
	public static void main(String[] args) {
		...
		set.add(new Account(1234, "Sankalp", 5000));
		set.add(new Account(123, "Sankalp", 5000));
		set.add(new Account(3456, "Akshay", 9000));
		set.add(new Account(1234, "KK", 5000));
		set.add(new Account(4567, "Amogh", 3000));
		set.add(new Account(5678, "Sameer", 10000));
...
//		System.out.println("Accounts in descending order ");
	...
	private static void printAccounts(HashSet<Account> list) {
